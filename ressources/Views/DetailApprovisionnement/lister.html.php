...
use Mouro\Core\Session;
            ...
            <div class="contenu" style='width:80%; height:auto; float: right;margin-top:2%'>
            <div class="donnees" style="background-color: red;width:40%;height:100px;color:white">
                                    ...
                                    <thead>
                                      ...
                                      <tbody>
                                        ...
                                        <tr class="table">
                                          ...
                                          <a href=""
                                          onclick="return confirm('vouler vous vraiment archiver cette projet ?')";>
                                         ...
                                         <?php for($i=1;$i<=$nombrepage;$i++):?>  
                                          ...
                                          <?php if($i == $page):?>
                                            ...
                                            <?php else:?>
                                              ...
                                              <a class="page-link" style="background: green;" href="<?= WEB_ROUTE.'?path=detail_approvisionnement&page='.$i?>"><?= $i ;?></a>
                                            </li>
                                            <?php endif?>
                                            <?php endfor ?> 

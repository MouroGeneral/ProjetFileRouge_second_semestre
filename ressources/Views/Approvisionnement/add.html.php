...
<div class="contenu" style='width:80%; height:auto; float: right; margin-top:2.4%;'>
              <h4 style="color:red;margin-top:0%;margin-left:20%">Ajouter une Approvisionnement</h4>
                                ...
                                <div class="col md-6">
                                   ...
                                   <div class="form-group" style="margin-top:2%">
                                       ...
                                       <input type="submit" class="btn btn-primary " 
                                        style="background:red;height:40px;margin-top:4%;width:10%" name="ok"  value="ok">
                                      ...
                                      <?php $montantTotal = 0;
                                         ...
                                         <tr class="table" style="border:1px solid black">
                                          ...
                                          <td>
                                            ...
                                            style="background-color:orange;">Supprimer</i></a>
                               ...
                               <?php  if (count($arrayDetails) !== 0):?>
                                           <div class="card-foter text-center">
                                             <input type="submit" class="btn btn-primary " value="enregistrer" name="enregistrer"
                                              style="width: 50%;margin-top:0.5%;background:red" desabled="desabled" >
                                           </div>
                              <?php  endif ?>           

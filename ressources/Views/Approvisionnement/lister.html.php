                                        ...
                                        <tr class="table">
                                          ...
                                          <div class="action" style="display: flex;justify-content:space-around">
                                             ...
                                             <a name="" id="" role="button" class="btn btn-primary" 
                                                href="<?= WEB_ROUTE.'?path=detail_approvisionnement&id='.$data->getId() ?>" style="background-color: green;">DetailAppro</i>
                                            </a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary"style="margin-left: -1%"  >Save changes</button>
                                </form>
                              </div>
                            </div>
                          </div>
                                         ...
                                         <?php for($i=1;$i<=$nombrepage;$i++):?>  
                                          ...
                                          <?php if($i == $page):?>
                                            ...
                                            <?php else:?>
                                              ...
                                              <a class="page-link" style="background: green;" href="<?= WEB_ROUTE.'?path=approvisionnement&page='.$i?>"><?= $i ;?></a>
                                            </li>
